    ...
    public partial class ExceptionView : MessageBase
    {
        ...
        public static DialogResult Show(Exception e, String pTitle)
        {
            ...
            using (ExceptionView wfrmMessageView = new ExceptionView())
            {
                ...
                wfrmMessageView.Detail =string.Concat(
                    "Codigo de error : ",Fwk.Exceptions.ExceptionHelper.GetFwkErrorId(e),
                    Environment.NewLine, Fwk.Exceptions.ExceptionHelper.GetAllMessageException(e)
                    );
        ...
        private void btnExpandCollapse_ItemClick(object sender, ItemClickEventArgs e)
        {
